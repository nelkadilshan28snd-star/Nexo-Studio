      ...
      <header style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '20px 32px', borderBottom: `1px solid ${themeStyles.border}`, backgroundColor: themeStyles.cardBg }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            <span style={{ fontWeight: '900', fontSize: '16px', color: themeStyles.text, letterSpacing: '1px', lineHeight: '1.2' }}>
              NEXO <span style={{ color: '#06b6d4' }}>STUDIO</span>
            </span>
            <span style={{ fontSize: '11px', color: themeStyles.subText, fontWeight: '600', marginTop: '2px' }}>
